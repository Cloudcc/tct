package com.cloudcc.terrariacraft.tile.blocks.furnace;

import com.cloudcc.terrariacraft.blocks.furnace.BlockYellowFurnace;
import com.cloudcc.terrariacraft.recipes.ModFurnaceRecipes;
 ...
 */
public class TEYellowFurnace extends TileEntityLockable implements ISidedInventory, ITickable
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.yellow_furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockYellowFurnace.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
